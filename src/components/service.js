  ...
  return (
    <div className="flex items-center justify-center min-h-screen sm:px-36 bg-white">
      <div className="container mx-auto px-8 py-16">
        <h2 className="text-3xl font-semibold mb-8 text-center md:text-left">Papers & Publications</h2>
        <div className="space-y-6">
          {services.map((service, index) => (
            <div key={index} className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-300 py-4">
              <div className="flex items-center space-x-4 mb-4 md:mb-0">
                <div className="text-2xl font-light items-center text-gray-800">{service.number}</div>
                <div className="pl-4 md:pl-10 mt-5">
