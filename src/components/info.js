...
const Info = () => {
  return (
    <div className="flex items-center justify-around  md:px-36 bg-white ml-10 sm:ml-0" data-aos="fade-up">
      <div className="container mx-auto ">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-start md:text-left">
            <p className="text-2xl font-light text-gray-800 w-[80%]  sm:ml-0" data-aos="fade-right">
